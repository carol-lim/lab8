...
public class ServerTranslationModel {
	...
	protected static String[] arabic = {"صباح الخير", "طاب مساؤك", "كي�? حالك؟", "شكرا لك", "مع السلامة", "ما أخبارك؟"};
	protected static String[] korean = {"좋�?� 아침", "안녕히 주무세요", "어떻게 지내세요?", "�?사합니다", "안녕", "�?야?"};
